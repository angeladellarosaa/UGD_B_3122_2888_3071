        ...
        <div className="col-span-8 flex flex-col min-h-0">
          <div className="flex-grow bg-[#150e24] rounded-[2.5rem] border border-white/5 overflow-hidden relative shadow-2xl">
            ...
            <div className="absolute top-8 right-8 bg-black/40 backdrop-blur-md border border-white/5 p-4 rounded-2xl text-right">
              ...
              <p className="text-[7px] text-gray-500 uppercase font-black">
                Active Sector
              </p>

              <p className="text-[10px] text-[#bc66ff] font-bold">
                SOUTH-EAST ASIA / A1
              </p>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                {[1, 2].map((item) => (
                  <div
                    key={item}
                    className="h-[150px] rounded-[1.8rem] bg-[#1a1126]/40 border border-white/5 animate-pulse"
                  />
                ))}
