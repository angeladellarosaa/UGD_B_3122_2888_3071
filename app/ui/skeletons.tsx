...
export function AdminDashboardSkeleton() {
  return (
    <div className={`p-6 min-h-screen bg-[#0d0415] animate-pulse`}>
      {/* Header Skeleton */}
      <div className="mb-8 space-y-2">
        <div className="h-6 w-48 rounded bg-[#1a0b2e]" />
        <div className="h-4 w-64 rounded bg-[#1a0b2e]" />
      </div>

      {/* Stats Cards Skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-[#1a0b2e]/80 p-6 rounded-[20px] h-32" />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#1a0b2e]/80 p-6 rounded-[24px] h-96" />
        
        {/* System Overview Skeleton */}
        <div className="bg-[#1a0b2e]/80 p-6 rounded-[24px] h-64" />
      </div>
    </div>
  );
}

// Tambahkan di paling bawah file app/ui/skeletons.tsx
export function StatsSkeleton() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="bg-[#1a0b2e]/50 p-6 rounded-[20px] h-32 animate-pulse" />
      ))}
    </div>
  );
}
...
export function ActivitySkeleton() {
  return (
    <div className="bg-[#1a0b2e]/50 p-6 rounded-[24px] h-96 animate-pulse" />
  );
}
    ...
    <div className="p-6 animate-pulse space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#1a0b2e]/50 border border-white/5 rounded-2xl p-6 h-[320px] space-y-4">
            <div className="h-4 w-32 bg-white/10 rounded-md mb-6" />
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-14 w-full bg-white/5 rounded-xl border border-white/5" />
            ))}
          </div>
          <div className="bg-[#1a0b2e]/50 border border-white/5 rounded-2xl p-6 h-[180px]" />
        </div>

        {/* Kolom Kanan */}
        <div className="space-y-6">
          <div className="bg-[#1a0b2e]/50 border border-white/5 rounded-2xl p-6 h-[250px] space-y-4">
            <div className="h-4 w-32 bg-white/10 rounded-md mb-4" />
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-4 w-full bg-white/5 rounded-md" />
            ))}
          </div>
          <div className="bg-[#1a0b2e]/50 border border-white/5 rounded-2xl p-6 h-[150px]" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-10 space-y-6">
      ...
      <div className="max-w-3xl space-y-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="flex gap-5 p-6 rounded-2xl bg-white/5 border border-white/10 animate-pulse">
