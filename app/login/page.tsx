  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-mono text-xs">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Overlay gradasi gelap untuk memastikan teks terbaca */}
        <div className="absolute inset-0 bg-black/60 z-1"></div>
      </div>

      {/* Konten Login - max-w ditingkatkan menjadi XL untuk frame yang lebih lebar */}
      <div className="relative z-10 w-full max-w-xl px-6 flex flex-col items-center">
        
        {/* Welcome Text (Di luar box) */}
        ...
        {/* --- Card Login: Padded & Rounded --- */}
        {/* max-w-xl memberikan lebar ekstra ke kanan/kiri. padding disesuaikan ke p-12 agar area ngetik lega */}
        <div className="w-full bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[4rem] p-10 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col items-center">
          ...
          <div className="flex items-center gap-4 mb-10 self-start">
            <div className="bg-white p-3 rounded-2xl shadow-lg">
              <div className="w-7 h-7 bg-[#0a051a] rounded-sm"></div> {/* Logo Placeholder */}
            </div>
          ...
          {/* Form - Space-y ditambah agar tidak sesak */}
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  // Padding kiri pl-16 untuk icon, padding kanan pr-6, rounded-2xl
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  placeholder="••••••••••••"
                  // Padding kanan pr-14 untuk memberi ruang icon mata
